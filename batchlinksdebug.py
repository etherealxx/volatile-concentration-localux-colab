...
linetoexecute = [
    'git clone -b v2.1 https://github.com/camenduru/stable-diffusion-webui /usr/zhuyao', 
    f'git clone {branch}https://github.com/etherealxx/batchlinks-webui /usr/zhuyao/extensions/batchlinks-webui'
    ]
